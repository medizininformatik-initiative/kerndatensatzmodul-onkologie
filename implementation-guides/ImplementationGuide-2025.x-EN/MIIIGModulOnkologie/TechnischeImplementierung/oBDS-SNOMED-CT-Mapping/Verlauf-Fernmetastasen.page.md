...
Distant metastases in the course. Note that when new distant metastases occur, the localization should be coded using the localization of distant metastases.
