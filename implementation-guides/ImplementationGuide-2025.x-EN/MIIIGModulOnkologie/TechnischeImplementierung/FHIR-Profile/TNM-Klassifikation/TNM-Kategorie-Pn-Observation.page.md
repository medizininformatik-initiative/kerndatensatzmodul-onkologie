...
parent: 
topic: TNM
subject: https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tnm-pn-kategorie
---

## {{page-title}}

This profile describes the Pn category of the TNM classification. The Pn category codes for perineural invasion.
...
@```
from StructureDefinition 
where url = 'https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tnm-pn-kategorie'  
...
2. The search parameter "_profile" MUST be supported:
    ...
    ```GET [base]/Observation?_profile=https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tnm-pn-kategorie```
...
{{json:mii-exa-onko-tnm-pn-kategorie-Pn1}}
