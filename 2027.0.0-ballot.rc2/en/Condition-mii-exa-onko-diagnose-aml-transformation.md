# MII EXA Onkologie Diagnose sekundäre AML (Transformation aus MDS) - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII EXA Onkologie Diagnose sekundäre AML (Transformation aus MDS)**

## Example Condition: MII EXA Onkologie Diagnose sekundäre AML (Transformation aus MDS)
