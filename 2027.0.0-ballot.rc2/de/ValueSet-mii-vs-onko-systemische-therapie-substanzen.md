# MII VS Onkologie Systemische Therapie Substanzen - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII VS Onkologie Systemische Therapie Substanzen**

## ValueSet: MII VS Onkologie Systemische Therapie Substanzen 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ValueSet/mii-vs-onko-systemische-therapie-substanzen | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-09 | *Maschinenlesbarer Name*:MII_VS_Onko_Systemische_Therapie_Substanzen |

 
Validierte ATC-Codes für Substanzen der systemischen Therapie basierend auf oBDS Umsetzungsleitfaden. Automatisch generiert und gegen MII-Terminologieserver validiert. 
...
```json
{
  ...
  "id" : "mii-vs-onko-systemische-therapie-substanzen",
  "meta" : {
    "extension" : [{
  ...
  "name" : "MII_VS_Onko_Systemische_Therapie_Substanzen",
