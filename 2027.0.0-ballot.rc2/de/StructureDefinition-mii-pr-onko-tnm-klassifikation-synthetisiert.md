# MII PR Onkologie TNM-Klassifikation (synthetisiert) - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Onkologie TNM-Klassifikation (synthetisiert)**

## Ressourcenprofil: MII PR Onkologie TNM-Klassifikation (synthetisiert) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tnm-klassifikation-synthetisiert | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-09 | *Maschinenlesbarer Name*:MII_PR_Onko_TNM_Klassifikation_Synthetisiert |
...
Diese Struktur ist abgeleitet von [MII_PR_Onko_TNM_Klassifikation](StructureDefinition-mii-pr-onko-tnm-klassifikation.md) 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-onko-tnm-klassifikation-synthetisiert.csv), [Excel](../StructureDefinition-mii-pr-onko-tnm-klassifikation-synthetisiert.xlsx), [Schematron](../StructureDefinition-mii-pr-onko-tnm-klassifikation-synthetisiert.sch) 
