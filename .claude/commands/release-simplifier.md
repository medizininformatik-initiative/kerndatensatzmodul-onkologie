...
2. Navigate to: https://simplifier.net/MedizininformatikInitiative-ModulOnkologie
...
1. Verify package appears at: https://packages.simplifier.net/de.medizininformatikinitiative.kerndatensatz.onkologie
...
```
For this project: `fhir project link MedizininformatikInitiative-ModulOnkologie --strategy TakeLocal`
...
```bash
fhir publish-package <package-name>.tgz --team MII
```
Example: `fhir publish-package de.medizininformatikinitiative.kerndatensatz.onkologie.2026.0.0.tgz --team MII`
