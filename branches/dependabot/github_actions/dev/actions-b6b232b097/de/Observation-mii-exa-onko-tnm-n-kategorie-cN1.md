# mii-exa-onko-tnm-n-kategorie-cN1 - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-onko-tnm-n-kategorie-cN1**

## Beispiel Observation: mii-exa-onko-tnm-n-kategorie-cN1
...
```json
{
  ...
  "id" : "mii-exa-onko-tnm-n-kategorie-cN1",
  "meta" : {
