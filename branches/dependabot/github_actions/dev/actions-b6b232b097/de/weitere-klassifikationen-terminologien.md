# Weitere Klassifikationen: Terminologien - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**CodeSystems**](code-systems.md)
* **Weitere Klassifikationen: Terminologien**
...
> Die Konzepte mit Code und Bezeichnung sowie deren Unterkonzepte sind auf der Artefaktseite [`mii-cs-onko-weitere-klassifikationen-obds`](CodeSystem-mii-cs-onko-weitere-klassifikationen-obds.md) dargestellt.
...
> Definition und Inhalt (Codes mit Bezeichnung) des Haupt-ValueSets sind auf der Artefaktseite [`mii-vs-onko-weitere-klassifikationen`](ValueSet-mii-vs-onko-weitere-klassifikationen.md) dargestellt.
...
> Kardinalitäten, Kurzbeschreibungen und Binding-Stärken der Elemente `Observation.code`, `Observation.method` und `Observation.value[x]:valueCodeableConcept` sind auf der Artefaktseite [`mii-pr-onko-weitere-klassifikationen`](StructureDefinition-mii-pr-onko-weitere-klassifikationen.md) dargestellt.
...
> Für die Weiteren Klassifikationen stehen die ValueSets [`mii-vs-onko-weitere-klassifikationen`](ValueSet-mii-vs-onko-weitere-klassifikationen.md) (Klassifikationssysteme) und [`mii-vs-onko-weitere-klassifikationen-auspraegungen`](ValueSet-mii-vs-onko-weitere-klassifikationen-auspraegungen.md) (Klassifikationswerte) bereit; Name, Beschreibung und Status sind dort jeweils angegeben.

### Gesamtes CodeSystem - Übersicht aller MII-definierten Codes

Die Haupt- und Unterkonzepte der MII-definierten Codes sind auf der Artefaktseite [`mii-cs-onko-weitere-klassifikationen-obds`](CodeSystem-mii-cs-onko-weitere-klassifikationen-obds.md) dargestellt.

### Mapping zu oBDS

Die Weitere Klassifikationen entsprechen dem **oBDS Feld 9 "Weitere Klassifikationen"**:

> Die oBDS-Mappings der einzelnen Elemente sind auf der Artefaktseite [`mii-pr-onko-weitere-klassifikationen`](StructureDefinition-mii-pr-onko-weitere-klassifikationen.md) im Abschnitt **Mappings** dargestellt.
