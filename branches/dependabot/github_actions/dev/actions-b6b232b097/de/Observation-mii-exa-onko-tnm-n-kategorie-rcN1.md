# mii-exa-onko-tnm-n-kategorie-rcN1 - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-onko-tnm-n-kategorie-rcN1**

## Beispiel Observation: mii-exa-onko-tnm-n-kategorie-rcN1
...
```json
{
  ...
  "id" : "mii-exa-onko-tnm-n-kategorie-rcN1",
  "meta" : {
