# mii-exa-onko-grading-1 - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2
...
Profile: [MII PR Onkologie Grading](StructureDefinition-mii-pr-onko-grading.md) version: 2027.0.0-ballot.rc2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-grading|2027.0.0-ballot.rc2"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
