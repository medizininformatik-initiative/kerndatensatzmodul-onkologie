# mii-sp-onko-observation-ext-tnm-n-sn-suffix - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-sp-onko-observation-ext-tnm-n-sn-suffix**

## SearchParameter: mii-sp-onko-observation-ext-tnm-n-sn-suffix (Experimentell) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/SearchParameter/mii-sp-onko-observation-ext-tnm-n-sn-suffix | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2024-04-15 | *Maschinenlesbarer Name*:MII_SP_Observation_Extension_TNM_N__SN_Suffix |
...
```json
{
  ...
  },
  {
    ...
    "valueString" : "MII SP Observation Extension TNM N  SN Suffix"
  },
  {
