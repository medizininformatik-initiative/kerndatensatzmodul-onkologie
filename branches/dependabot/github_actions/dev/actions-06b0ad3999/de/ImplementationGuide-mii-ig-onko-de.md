# MII ImplementationGuide Ressource - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ImplementationGuide/mii-ig-onko-de",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://www.meddra.org"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-meddra.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/meddra"
      },
      "name" : "MedDRA (Fragment, nur Codes)",
      "description" : "Fragment des MedDRA-Systems (https://www.meddra.org): ausschliesslich die in diesem Modul verwendeten Code-IDs der CTCAE-v4.03-Terme, ohne Terms und ohne Hierarchie (MedDRA-Lizenz). Displays und deutsche Bezeichnungen liefert das Supplement mii-cs-onko-nebenwirkung-meddra-de.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "therapieziele.html"
        }],
        "nameUrl" : "therapieziele.html",
        "title" : "Therapy Goals",
        "generation" : "markdown"
      },
      {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "ImplementationGuide-mii-ig-onko-de.html"
        }],
        "nameUrl" : "ImplementationGuide-mii-ig-onko-de.html",
