# MII LM Modellvorhaben Genomsequenzierung Onkologie - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII LM Modellvorhaben Genomsequenzierung Onkologie**

## Logisches Modell: MII LM Modellvorhaben Genomsequenzierung Onkologie 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-lm-mvgenomseq-onkologie | *Version*:2027.0.0-ballot |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_LM_MVGenomSeq_Onkologie |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-lm-mvgenomseq-onkologie.csv), [Excel](../StructureDefinition-mii-lm-mvgenomseq-onkologie.xlsx) 
