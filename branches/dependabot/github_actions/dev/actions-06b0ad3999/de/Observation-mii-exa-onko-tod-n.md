# mii-exa-onko-tod-n - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot
...
Profile: [MII PR Onkologie Tod](StructureDefinition-mii-pr-onko-tod.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tod|2027.0.0-ballot"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
