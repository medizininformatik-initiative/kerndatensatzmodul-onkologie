# MII PR Onkologie TNM y-Symbol - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Onkologie TNM y-Symbol**

## Ressourcenprofil: MII PR Onkologie TNM y-Symbol 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tnm-y-symbol | *Version*:2027.0.0-ballot |
| Retired Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_Onko_TNM_y_Symbol |
...
> **DEPRECATED (v2027):** Dieses eigenständige Symbol-Profil ist abgelöst — y-Symbole werden als **modifierExtension an den T-/N-/M-Kategorien** erfasst (oBDS 8.3–8.5). Das Profil bleibt zum Lesen von Bestandsdaten definiert (Status: retired).
...
* Examples for this Profile: [Observation/TNM-y-Symbol-Observation-2](Observation-TNM-y-Symbol-Observation-2.md), [Observation/mii-exa-onko-kim-klass2-ysym](Observation-mii-exa-onko-kim-klass2-ysym.md) and [Observation/mii-exa-onko-kim-klass3-ysym](Observation-mii-exa-onko-kim-klass3-ysym.md)
* CapabilityStatements using this Profile: [MII CPS Onkology CapabilityStatement](CapabilityStatement-mii-cps-onko-capabilitystatement.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.onkologie|current/StructureDefinition/StructureDefinition-mii-pr-onko-tnm-y-symbol.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-onko-tnm-y-symbol.csv), [Excel](../StructureDefinition-mii-pr-onko-tnm-y-symbol.xlsx), [Schematron](../StructureDefinition-mii-pr-onko-tnm-y-symbol.sch) 
    ...
    },
    {
      ...
      "_definition" : {
        "extension" : [{
          ...
          {
            "url" : "content",
            "valueString" : "TNM Klassifikation nach/ während multimodaler Therapie nach 8.3 oBDS 2021"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
