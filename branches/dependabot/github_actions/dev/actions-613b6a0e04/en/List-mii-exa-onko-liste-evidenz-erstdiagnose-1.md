# Liste der Evidenz zum Erstdiagnosezeitpunkt - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot
...
Profile: [MII PR Onkologie Evidenz Diagnose Primärtumor](StructureDefinition-mii-pr-onko-liste-evidenz-erstdiagnose.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-liste-evidenz-erstdiagnose|2027.0.0-ballot"]
  },
  "status" : "current",
  "mode" : "snapshot",
