...
* **mii-sp-onko-observation-ext-tnm-n-cppraefix**

## SearchParameter: mii-sp-onko-observation-ext-tnm-n-cppraefix (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/SearchParameter/mii-sp-onko-observation-ext-tnm-n-cppraefix | *Version*:2026.0.3 |
| Active as of 2024-04-15 | *Computable Name*:MII_SP_Observation_Extension_TNM_N_CpPraefix |
