# MII PR Onkologie TNM m-Symbol - MII IG Kerndatensatz-Modul Onkologie v2026.0.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Onkologie TNM m-Symbol**

## Resource Profile: MII PR Onkologie TNM m-Symbol 
...
| Active as of 2026-07-23 | *Computable Name*:MII_PR_Onko_TNM_m_Symbol |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-pr-onko-tnm-m-symbol.json)
...
Other representations of profile: [CSV](StructureDefinition-mii-pr-onko-tnm-m-symbol.csv), [Excel](StructureDefinition-mii-pr-onko-tnm-m-symbol.xlsx), [Schematron](StructureDefinition-mii-pr-onko-tnm-m-symbol.sch) 
