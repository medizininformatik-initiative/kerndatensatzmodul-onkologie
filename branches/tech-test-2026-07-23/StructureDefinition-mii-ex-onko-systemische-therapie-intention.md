...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-ex-onko-systemische-therapie-intention | *Version*:2026.0.3 |
| Active as of 2026-07-23 | *Computable Name*:MII_EX_Onko_Systemische_Therapie_Intention |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-ex-onko-systemische-therapie-intention.json)
...
Other representations of profile: [CSV](StructureDefinition-mii-ex-onko-systemische-therapie-intention.csv), [Excel](StructureDefinition-mii-ex-onko-systemische-therapie-intention.xlsx), [Schematron](StructureDefinition-mii-ex-onko-systemische-therapie-intention.sch) 
