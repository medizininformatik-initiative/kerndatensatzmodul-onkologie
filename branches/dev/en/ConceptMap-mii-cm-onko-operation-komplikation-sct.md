...
## ConceptMap: MII CM Onko Operation Komplikation SNOMED Mapping (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ConceptMap/mii-cm-onko-operation-komplikation-sct | *Version*:2027.0.0-ballot.rc1 |
...
The complications are assigned directly at the time of surgery. If a code cannot be represented with this list, the complication should be coded using ICD-10.

> The complete mapping table (oBDS coding ↔ SNOMED CT with equivalence level and comments) is generated from the ConceptMap below this introduction.
