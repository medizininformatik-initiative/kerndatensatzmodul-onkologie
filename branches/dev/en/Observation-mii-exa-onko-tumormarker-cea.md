# MII EXA Onkologie Tumormarker CEA - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII EXA Onkologie Tumormarker CEA**

## Example Observation: MII EXA Onkologie Tumormarker CEA
...
Profile: [MII PR Onkologie Tumormarker](StructureDefinition-mii-pr-onko-tumormarker.md) version: 2027.0.0-ballot.rc3
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tumormarker|2027.0.0-ballot.rc3"]
  },
  "identifier" : [{
    "type" : {
      "coding" : [{
