# mii-sp-onko-observation-ext-tnm-n-itc - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-sp-onko-observation-ext-tnm-n-itc**

## SearchParameter: mii-sp-onko-observation-ext-tnm-n-itc (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/SearchParameter/mii-sp-onko-observation-ext-tnm-n-itc | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2024-04-15 | *Computable Name*:MII_SP_Observation_Extension_TNM_N_ITC |

 
SearchParameter for Observation.extension[itc] 
...
```json
{
  ...
  "id" : "mii-sp-onko-observation-ext-tnm-n-itc",
  "meta" : {
    "extension" : [{
  ...
  },
  {
    ...
    "valueString" : "MII SP Observation Extension TNM N ITC"
  },
  {
