...
Für eine detaillierte Bewertung auf Basis internationaler Klassifikationen kann die MII Variante aus dem Molekulargenetischen Befundbericht genutzt werden (siehe [Genetische Variante: Observation](StructureDefinition-mii-pr-onko-genetische-variante.md)).
