# MII CM Onko Verlauf Primaertumor SNOMED Mapping - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII CM Onko Verlauf Primaertumor SNOMED Mapping**

## ConceptMap: MII CM Onko Verlauf Primaertumor SNOMED Mapping (Experimentell) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ConceptMap/mii-cm-onko-verlauf-primaertumor-sct | *Version*:2027.0.0-ballot.rc2 |
