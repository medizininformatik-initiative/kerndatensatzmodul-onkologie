# mii-exa-onko-verlauf-tumor - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc3

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-onko-verlauf-tumor**

## Beispiel Observation: mii-exa-onko-verlauf-tumor
...
Profile: [MII PR Onkologie Verlauf](StructureDefinition-mii-pr-onko-verlauf.md) version: 2027.0.0-ballot.rc3
...
**value**: klinische Besserung des Zustandes, Teilremissionkriterien jedoch nicht erfüllt (minimal response, MR)

> **component****code**: Status of residual neoplasm (observable entity)**value**: Tumorreste (Residualtumor)

> **component****code**: Presence of metastatic neoplasm in regional lymph node (observable entity)**value**: bekannter Lymphknotenbefall Progress
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-verlauf|2027.0.0-ballot.rc3"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
