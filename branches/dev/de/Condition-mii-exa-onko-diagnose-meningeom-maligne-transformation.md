# MII EXA Onkologie Diagnose malignes Meningeom (Transformation /0 → /3) - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII EXA Onkologie Diagnose malignes Meningeom (Transformation /0 → /3)**

## Beispiel Condition: MII EXA Onkologie Diagnose malignes Meningeom (Transformation /0 → /3)
