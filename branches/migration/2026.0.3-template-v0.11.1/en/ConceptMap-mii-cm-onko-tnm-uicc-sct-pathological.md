# MII CM Onko Pathological TNM UICC SNOMED - MII IG Kerndatensatz-Modul Onkologie v2026.0.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII CM Onko Pathological TNM UICC SNOMED**

## ConceptMap: MII CM Onko Pathological TNM UICC SNOMED 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ConceptMap/mii-cm-onko-tnm-uicc-sct-pathological | *Version*:2026.0.3 |
| Active as of 2024-01-05 | *Computable Name*:MII CM Onko Pathological TNM UICC SCT Mapping |
| **Copyright/Legal**: This material includes SNOMED Clinical Terms® (SNOMED CT®) which is used by permission of SNOMED International. All rights reserved. SNOMED CT®, was originally created by The College of American Pathologists. SNOMED and SNOMED CT are registered trademarks of SNOMED International. Implementers of these artefacts must have the appropriate SNOMED CT Affiliate license. | |

 
Mapping pathological TNM UICC Codes zu SNOMED-CT 
...
The table below represents one possible mapping to the pathological TNMs (cTNMs).
