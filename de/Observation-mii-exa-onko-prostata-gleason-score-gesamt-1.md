# mii-exa-onko-prostata-gleason-score-gesamt-1 - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-onko-prostata-gleason-score-gesamt-1**

## Beispiel Observation: mii-exa-onko-prostata-gleason-score-gesamt-1
...
Profile: [MII PR Onkologie Prostata Gleason Score Gesamt](StructureDefinition-mii-pr-onko-prostate-gleason-score-gesamt.md) version: 2027.0.0-ballot.rc2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-prostate-gleason-score-gesamt|2027.0.0-ballot.rc2"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
