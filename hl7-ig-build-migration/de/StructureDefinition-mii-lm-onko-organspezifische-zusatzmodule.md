...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-lm-onko-organspezifische-zusatzmodule.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "mapping" : [{
        "identity" : "FHIR",
        "map" : "Observation.where(code.coding.system='http://radlex.org' and code.coding.code='RDE96')"
      },
      {
        "identity" : "oBDS",
        "map" : "KR5",
