# mii-exa-onko-trastuzumab-therapie - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-onko-trastuzumab-therapie**

## Beispiel Procedure: mii-exa-onko-trastuzumab-therapie
...
Profile: [MII PR Onkologie Systemische Therapie](StructureDefinition-mii-pr-onko-systemische-therapie.md) version: 2027.0.0-ballot.1
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-systemische-therapie|2027.0.0-ballot.1"]
  },
  "extension" : [{
  ...
  "code" : {
    "coding" : [{
      ...
      "version" : "2024",
      "code" : "6-001.k",
      "display" : "Applikation von Medikamenten, Liste 1: Trastuzumab, intravenös"
    },
    {
