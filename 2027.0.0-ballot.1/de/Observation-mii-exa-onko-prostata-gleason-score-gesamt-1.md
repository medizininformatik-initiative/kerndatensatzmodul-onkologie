# mii-exa-onko-prostata-gleason-score-gesamt-1 - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.1
...
Profile: [MII PR Onkologie Prostata Gleason Score Gesamt](StructureDefinition-mii-pr-onko-prostate-gleason-score-gesamt.md) version: 2027.0.0-ballot.1
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-prostate-gleason-score-gesamt|2027.0.0-ballot.1"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
