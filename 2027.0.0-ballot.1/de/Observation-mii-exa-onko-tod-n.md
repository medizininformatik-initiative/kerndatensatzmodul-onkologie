# mii-exa-onko-tod-n - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot.1
...
Profile: [MII PR Onkologie Tod](StructureDefinition-mii-pr-onko-tod.md) version: 2027.0.0-ballot.1
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tod|2027.0.0-ballot.1"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
