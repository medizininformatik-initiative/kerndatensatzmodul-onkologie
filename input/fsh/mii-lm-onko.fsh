...
* Operation 0..* BackboneElement "Operation"
  * OPIntention 0..1 code "" ""
  * OPDatum 0..1 code "" ""
  * OPSCode  0..* code "" ""
  * OPSVersion 0..1 code "" "" 
  * OPKomplikation 0..* code "" ""
* Strahlentherapie 0..* BackboneElement "Strahlentherapie"
  * StrahlenTxIntention 0..1 code "" ""
  * StrahlenTxStellung  0..1 code "" ""
  * StrahlenTxZielgebiet  0..* code "" ""
  * StrahlenTxSeiteZielgebiet 0..*  code "" ""
  * StrahlenTxBeginn  0..1 date "" ""
  * StrahlenTxEnde  0..1 date "" ""
  * StrahlenTxApplikationsart 0..1 code "" ""
  * Strahlenart  0..1 code "" ""
  * StrahlenTxGesamtdosis 0..1 code "" ""
  * StrahlenTxEinzeldosis 0..1 code "" ""
  * StrahlenTxEinheit 0..1 code "" ""
  * Boost  0..1 code "" ""
  * StrahlenTxEndeGrund 0..1 code "" ""
* SystemischeTherapie 0..* BackboneElement "Systemische Therapie" 
  * SysTxIntention  0..1 code "" ""
  * SysTxStellung  0..1 code "" ""
  * SysTxArtTherapie 0..1 code "" ""
  * SysTxBeginn  0..1 date "" ""
  * SysTxEnde  0..1 date "" ""
  * SysTxEndeGrund  0..1 code "" ""
...
* Strahlentherapie
  * StrahlenTxIntention -> "Procedure.extension[Intention].valueCodeableConcept.coding.code"
  * StrahlenTxStellung -> "Procedure.extension[Stellung].valueCodeableConcept.coding.code."
  * StrahlenTxZielgebiet -> "Procedure.extension[Behandlungsabschnitt].extension[Zielgebiet].valueCodeableConcept.coding.code"
  * StrahlenTxSeiteZielgebiet -> "Procedure.extension[Behandlungsabschnitt].extension[Zielgebiet_Lateralitaet].valueCodeableConcept.coding.code"
  * StrahlenTxBeginn -> "Procedure.performedPeriod.start"
  * StrahlenTxEnde -> "Procedure.performedPeriod.end"
  * StrahlenTxApplikationsart -> "Procedure.extension[Behandlungsabschnitt].extension[Applikationsart].valueCodeableConcept.coding.code"
  * Strahlenart -> "Procedure.extension[Behandlungsabschnitt].extension[Strahlenart].valueCodeableConcept.coding.code"
  * StrahlenTxGesamtdosis -> "Procedure.extension[Behandlungsabschnitt].extension[Gesamtdosis].valueQuantity.value"
  * StrahlenTxEinzeldosis -> "Procedure.extension[Behandlungsabschnitt].extension[Einzeldosis].valueQuantity.value"
  * StrahlenTxEinheit -> "Procedure.extension[Behandlungsabschnitt].extension[Einheit].valueCodeableConcept.coding.code"
  * Boost -> "Procedure.extension[Behandlungsabschnitt].extension[Boost].valueCodeableConcept.coding.code"
  * StrahlenTxEndeGrund -> "Procedure.outcome.coding.code"
* SystemischeTherapie
