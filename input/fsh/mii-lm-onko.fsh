...
* Strahlentherapie 0..* BackboneElement "Strahlentherapie"
  ...
  * StrahlentherapieBestrahlung 0..* BackboneElement "Bestrahlung" "Dieser Abschnitt entspricht einer Bestrahlung mit spezifischem Zielgebiet, Methodik und Dosis "
...
* TumorkonferenzTherapieempfehlung 0..* BackboneElement "Tumorkonferenz und Therapieempfehlung"
  * TherapieplanungDatum 1..1 date "Tumorkonferenz Therapieplanung Datum" "Datum der Durchführung der Tumorkonferenz bzw. der sonstigen Therapieplanung."
  * TherapieplanungTyp 1..1 code "Tumorkonferenz Therapieplanung Typ" "Typ der Tumorkonferenz bzw. der sonstigen Therapieplanung." 
  * TherapieempfehlungTyp 1..* code "Tumorkonferenz Therapieempfehlung Typ" "Typ der Therapieempfehlung der Tumorkonferenz."
  * TherapieAbweichungPatientenwunsch 1..* code "Tumorkonferenz/Therapieempfehlung Therapieabweichung auf Wunsch des Patienten" "Abweichung auf Wunsch des Patienten."
...
* TumorkonferenzTherapieempfehlung
  ...
  * TherapieempfehlungTyp -> "CarePlan.activity.detail.code"
  * TherapieAbweichungPatientenwunsch -> "CarePlan.activity.detail.status & statusReason"
* Tod
