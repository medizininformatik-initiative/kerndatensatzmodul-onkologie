...
* subject = Reference(Patient/example)
* focus[Diagnose] = Reference (Condition/exampleOncologicCondition)
* focus[Operation] = Reference ( mii-exa-onko-prostata-surgery-1)
* effectiveDateTime = "2024-06-24"
* valueCodeableConcept.coding[ClavienDindo] = $SCT#1367520006 "Clavien-Dindo classification grade IIIa (finding)"
