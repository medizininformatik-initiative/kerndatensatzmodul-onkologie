...
* insert Label(valueCodeableConcept.coding, Globaler Residualstatus, Globaler Residualstatus nach 10.2 oBDS 2021. Der lokale Residualstatus von Operationen wird direkt an der Operation kodiert. )
* insert Translation(valueCodeableConcept.coding ^short, de-DE, Globaler Residualstatus )
* insert Translation(valueCodeableConcept.coding ^definition, de-DE, Globaler Residualstatus nach 10.2 oBDS 2021. Der lokale Residualstatus von Operationen wird direkt an der Operation kodiert.)
