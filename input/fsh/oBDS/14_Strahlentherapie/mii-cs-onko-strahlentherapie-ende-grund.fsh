CodeSystem: MII_CS_Onko_Strahlentherapie_Ende_Grund
Id: mii-cs-onko-strahlentherapie-ende-grund
Title: "MII CS Onkologie Strahlentherapie Ende Grund"
Description: "oBDS-spezifisches Codesystem für Klassifikation des Grundes der Beendigung der Strahlentherapie"
* ^meta.profile = "http://hl7.org/fhir/StructureDefinition/shareablecodesystem"
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/CodeSystem/mii-cs-strahlentherapie-grund-ende"
* ^status = #draft
* ^experimental = false
* insert Publisher
