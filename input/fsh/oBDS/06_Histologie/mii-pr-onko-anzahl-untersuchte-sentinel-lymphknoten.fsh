...
* valueQuantity.code ^comment = "This quantity must be mandatorily coded with the UCUM code 1."
* valueQuantity.system 1.. MS
* valueQuantity.system = $UCUM (exactly)
* valueQuantity.unit 1.. MS
* valueQuantity.value 1.. MS
* insert Label (valueQuantity.value, Anzahl untersuchter Sentinel-Lymphknoten, Anzahl untersuchter Sentinel-Lymphknoten nach 6.8 oBDS 2021)
* insert Translation(valueQuantity.value ^short, de-DE, Anzahl untersuchter Sentinel-Lymphknoten )
* insert Translation(valueQuantity.value ^definition, de-DE, Anzahl untersuchter Sentinel-Lymphknoten nach 6.9 oBDS 2021 )
