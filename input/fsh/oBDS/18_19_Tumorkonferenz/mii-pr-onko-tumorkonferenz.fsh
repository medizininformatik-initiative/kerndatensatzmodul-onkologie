...
* insert Label(activity.detail.code.coding, Status der Therapieempfehlung, Status der Therapieempfehlung nach HL7 FHIR CarePlanActivityStatus | not-started | scheduled | in-progress | on-hold | completed | cancelled | stopped | unknown | entered-in-error |)
...
* insert Label(activity.detail.code.coding, Therapieabweichung aufgrund Patientenwunsch der Therapieempfehlung, wenn Therapieabweichung - z.B. status = cancelled - Aussage ob dies durch Patientenwunsch erfolgt ist gemäß 19.2 oBDS 2021.)
