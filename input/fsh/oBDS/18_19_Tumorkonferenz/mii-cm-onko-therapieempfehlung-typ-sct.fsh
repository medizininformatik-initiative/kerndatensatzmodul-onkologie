Instance: MII-CM-Onko-Therapieempfehlung-Typ-SCT-Mapping
InstanceOf: ConceptMap
Usage: #definition
* url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ConceptMap/mii-cm-onko-therapieempfehlung-typ-sct"
* name = "MII_CM_Onko_Therapieempfehlung_Typ_SNOMED_Mapping"
* title = "MII CM Onko Therapieempfehlung Typ SNOMED Mapping"
* status = #draft
* experimental = false
* date = "2024-04-11"
* description = "Mapping Therapieempfehlung Typ Codes zu SNOMED-CT"
* purpose = "Technical mapping to transform oBDS-Data into SNOMED"
* sourceUri = "https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/"
* targetUri[+] = "http://snomed.info/sct"
* group[+].source = $mii-cs-onko-therapieempfehlung-typ
...
* group[=].element[=].target.display = "Chemotherapy for malignant neoplastic disease using targeted agent (procedure)"
* group[=].element[=].target.equivalence = #narrower
* group[=].element[=].target.comment = "Ist eine UND Komnination aus zwei SNOMED CT Codes"
