Instance: MII-CM-Onko-Lymphknoten-SCT-Mapping
InstanceOf: ConceptMap
Usage: #definition
* url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/ConceptMap/mii-cm-onko-lymphknoten-sct"
* name = "MII_CM_Onko_Lymphknoten_SNOMED_Mapping"
* title = "MII CM Onko Lymphknoten SNOMED Mapping"
* status = #draft
* experimental = false
* date = "2024-04-10"
...
* group[=].element[=].target.comment = "Tumorstatus Lymphknoten"
