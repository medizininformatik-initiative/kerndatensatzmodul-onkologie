...
* group[=].element[=].target[+].code = #LA9622-7
...
* group[=].element[=].target[+].code = #LA9623-5
...
* group[=].element[=].target[+].code = #LA9624-3
...
* group[=].element[=].target[+].code = #LA9625-0
...
* group[=].element[=].target[+].code = #LA9626-8
