// Dieses ValueSet wurde nur erstellt, um die Nebenwirkung mit AdverseEvent Ressourcentyp zu profilierung
...
* ^url = $mii-vs-onko-nebenwirkung-ctcae-grad-adverse-event
* ^status = #draft
* ^experimental = false
