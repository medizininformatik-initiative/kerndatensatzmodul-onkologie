...
Each entry is explained individually on the [Migration from v2026](migration-v2026.html)
page — with its effect on stored data, its effect on implementations, and a concrete
migration path:
