...
> Diese Release Notes wurden aus dem Quell-IG übernommen. Verweise auf einzelne Profile (ehemals Simplifier-`pagelink`-Direktiven) sind als lesbare Bezeichnungen geführt; die zugehörigen Artefaktseiten finden sich unter [Artefakte](artifacts.html). `TODO:REVIEW` — optional als direkte Artefakt-Links verknüpfen.
