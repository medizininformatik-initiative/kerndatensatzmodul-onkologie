...
**Abend 2026-08-26 (dritte Runde — IG-Strukturentscheid):** `a67`✅ **2027er Split** (User-Entscheid: 2026er Guide persistiert als v2026.0.3, kein 2027er Simplifier-Space mehr): `ImplementationGuide-2027.x-DE` = Staging-Korpus aller v2027-Seiten (README erklärt Status), 2026.x-DE auf dev eingefroren (diff-leer verifiziert), Workflow-/Tooling-Pfade umgezogen; **v2027-IG entsteht via IG-Publisher-Migration (`14w.14`, Skill `mii-ig-migration` mit 4 Review-Gates — eigene Session!)** · Release-Notes v2027 konsolidiert (alle Branch-Pakete, 2 Breaking) · `14w.28`✅ (Ausprägungsachse M/W/P/N/U+S, ConceptMap war vollständig, Doku hinkte) · `c9e`✅ (BestrahlungProcedure; Bonusfang toter Release-Notes-pagelink → TNMKlassifikationObservation; Rest-Cluster 12×'TNM' → `03j`) · neue Tickets: `c2n` (SCT-memberOf-Warnungen), `rh5` (Panel-DQ CQL), `0mm` (KDL→SCT-Map), `03j` (topic-Cluster).
