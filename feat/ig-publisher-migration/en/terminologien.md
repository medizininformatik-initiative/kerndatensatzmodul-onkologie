# Terminologien - MII IG Kerndatensatz-Modul Onkologie v2026.0.3
...
Der Operations- und Prozedurenschlüssel (OPS) wird benutzt, um operative Prozeduren zu kodieren, die im Rahmen der onkologischen Diagnostik und Therapie durchgeführt werden. Die aktuelle Version ist hier verfügbar: https://www.bfarm.de/DE/Kodiersysteme/Klassifikationen/OPS-ICHI/OPS/_node.html
...
UNII-Datenbank: https://precision.fda.gov/uniisearch UNII-CodeSystem in FHIR: http://fdasis.nlm.nih.gov
...
* [Terminologien: Systemische Therapie](terminologien-systemische-therapie.md)
* [Terminologien: Weitere Klassifikationen](terminologien-weitere-klassifikationen.md)
