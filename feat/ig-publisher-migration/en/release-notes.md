# Release Notes - MII IG Kerndatensatz-Modul Onkologie v2026.0.3
...
* `feat` **Frühere Tumorerkrankungen Profil**: Neues [MII PR Onkologie Frühere Tumorerkrankung](StructureDefinition-mii-pr-onko-fruehere-tumorerkrankung.md) Profil zur Erfassung anamnestischer Tumorerkrankungen mit Mapping zu oBDS 5.9 
...
* **Erweiterte [MII PR Onkologie Tumorkonferenz](StructureDefinition-mii-pr-onko-tumorkonferenz.md)** zur Unterstützung sowohl bisheriger oBDS-Darstellung der Tumorkonferenzen als auch komplexere Darstellung von Therapieempfehlungen wie im Modul Molekulares Tumorboard
* **Grund**: FHIR R4 Invariant cpl-3 verhindert gleichzeitige Nutzung von `activity.detail.code` und `activity.reference`
* **Lösung**: Activity-Slicing mit `obds` (Standard oBDS 19.1 Kategorisierung) und `extended` ([MII PR Onkologie Therapieempfehlung Kombinationstherapie](StructureDefinition-mii-pr-onko-therapieempfehlung-kombinationstherapie.md)-basierte Protokolle) Slices
...
* **usedCode-Implementierung**: Strukturierte Dokumentation von Therapieprotokollen in [MII PR Onkologie Systemische Therapie](StructureDefinition-mii-pr-onko-systemische-therapie.md) 
...
* **Dual-Coding-Support**: [MII PR Onkologie Systemische Therapie Medikation](StructureDefinition-mii-pr-onko-systemische-therapie-medikation.md) erweitert um UNII-Slice zusätzlich zum bestehenden ATC-Slice 
...
### MII PR Onkologie Operation Erweiterungen
...
* **Neue Extension**: [MII EX Onko Operation Urgency](StructureDefinition-mii-ex-onko-operation-urgency.md) zur Erfassung der Eingriffsmodalität 
...
* **Integration**: Extension in allgemeines [MII PR Onkologie Operation](StructureDefinition-mii-pr-onko-operation.md) Profil integriert für breite Anwendbarkeit
 

### Verlauf-Profil Anpassungen

* **Component-Kardinalität**: Änderung von `component 1..*` zu `component 0..*` im [MII PR Onkologie Allgemeiner Leistungszustand ECOG](StructureDefinition-mii-pr-onko-allgemeiner-leistungszustand-ecog.md) 
...
* **oBDS 2014 CodeSystem Integration**: Unterstützung für oBDS 2014 Zielgebiet-Definitionen zur Abwärtskompatibilität in [MII PR Onkologie Strahlentherapie](StructureDefinition-mii-pr-onko-strahlentherapie.md) 
...
* **Mamma**: Vollständige Implementierung des [Mamma Module](organspezifische-mamma.md) 
* **Estrogen-Rezeptorstatus**: [MII PR Onkologie Rezeptorstatus Estrogen](StructureDefinition-mii-pr-onko-mamma-rezeptorstatus-estrogen.md) mit dualer Kodierung (oBDS/S3-Leitlinien) und Komponenten für Anteil positiver Zellen und Färbeintensität
* **Progesteron-Rezeptorstatus**: [MII PR Onkologie Rezeptorstatus Progesteron](StructureDefinition-mii-pr-onko-mamma-rezeptorstatus-progesteron.md) mit identischer Struktur zum Estrogen-Status
* **Menopause-Status**: [MII PR Onkologie Menopausenstatus Mamma](StructureDefinition-mii-pr-onko-mamma-menopause-status.md) mit oBDS 2021-konformer Subsumierung (perimenopausal → prämenopausal)
* **Präoperative Markierung**: [MII PR Onkologie Präoperative Markierung Mamma](StructureDefinition-mii-pr-onko-mamma-praeoperative-markierung.md) für verschiedene Markierungsmodalitäten (Draht, Seeds, magnetisch)
* **Mamma-Operation**: [MII PR Onkologie Mamma Operation](StructureDefinition-mii-pr-onko-mamma-operation.md) mit SNOMED CT und OPS ValueSets
* **Hinweise**: Her2Neu im Molecular Tumorboard-Profil; Tumorgröße im Histologie-Modul; Studienteilnahme in oBDS 2021 abgedeckt
 
* **Prostata**: Vollständige Implementierung des [Prostata Module](organspezifische-prostata.md) 
* **PSA**: [MII PR Onkologie PSA-Wert](StructureDefinition-mii-pr-onko-prostate-psa.md) mit LOINC 2857-1 Kodierung
* **Anzahl Stanzen**: [MII PR Onkologie Prostata Anzahl Stanzen](StructureDefinition-mii-pr-onko-prostate-anzahl-stanzen.md) (LOINC 33743-6)
* **Anzahl positive Stanzen**: [MII PR Onkologie Prostata Anzahl positiver Stanzen](StructureDefinition-mii-pr-onko-prostate-anzahl-positive-stanzen.md) (LOINC 33746-9)
* **Karzinom-Befall Stanze**: [MII PR Onkologie Ca-Befall Stanze](StructureDefinition-mii-pr-onko-prostate-ca-befall-stanze.md) (LOINC 33748-5)
* **Gleason Score/Grade Group**: [MII PR Onkologie Prostata Gleason Grade Group](StructureDefinition-mii-pr-onko-prostate-gleason-grade-group.md) (LOINC 44648-7)
* **Gleason Patterns**: Primäre und sekundäre Gleason-Grad-Komponenten
* **Clavien-Dindo**: [MII PR Onkologie Clavien Dindo](StructureDefinition-mii-pr-onko-prostate-clavien-dindo.md) mit dualer Kodierung (SNOMED CT + oBDS)
 
* **Kolorektales Karzinom**: Vollständige Implementierung des [KRKModule](organspezifische-krk.md) 
* **Abstand Anokutanlinie**: [MII PR Onkologie Abstand Anokutan](StructureDefinition-mii-pr-onko-krk-abstand-anokutan.md) (oBDS KR1, LOINC 33748-5)
* **Circumferelle Resektionsebene**: [MII PR Onkologie Abstand Circumferelle Resektionsebene](StructureDefinition-mii-pr-onko-krk-abstand-circumferelle-resektionsebene.md) (oBDS KR3)
* **Aboraler Resektionsrand**: [MII PR Onkologie Abstand Aboral](StructureDefinition-mii-pr-onko-krk-abstand-aboral.md) (oBDS KR2)
* **MRT Mesorektale Faszie**: [MII PR Onkologie KRK MRT/CT Abstand Mesorektale Faszie](StructureDefinition-mii-pr-onko-krk-mrt-mesorektale-faszie.md) mit Abstandsmessung (oBDS KR2)
* **ASA-Klassifikation**: [MII PR Onkologie ASA-Klassifikation](StructureDefinition-mii-pr-onko-asa-klassifikation.md) (oBDS KR9, LOINC 97816-3)
* **Anastomoseninsuffizienz**: [MII PR Onkologie KRK Anastomoseninsuffizienz](StructureDefinition-mii-pr-onko-krk-anastomoseninsuffizienz.md) (oBDS KR8, SNOMED CT 235919008)
* **KRK-Operation**: [MII PR Onkologie Präoperative Drahtmarkierung Mamma](StructureDefinition-mii-pr-onko-krk-operation.md) mit TME-Qualitätsbewertung (oBDS KR4)
* **KRK-Specimen**: [MII PR Onkologie Specimen](StructureDefinition-mii-pr-onko-krk-specimen.md) mit pathologischer TME-Qualität
* **Stoma-Markierung**: [MII PR Onkologie KRK Stoma-Markierung](StructureDefinition-mii-pr-onko-krk-stoma-markierung.md) (oBDS KR7)
* **Bundle-Beispiel**: [KRKBundle](example-krk-bundle.md) demonstriert vollständigen KRK-Workflow
 
* **Malignes Melanom**: Vollständige Implementierung des [Malignes Melanom Module](organspezifische-melanom.md) 
* **Breslow-Tiefe**: [MII PR Onkologie Melanom Breslow Tiefe](StructureDefinition-mii-pr-onko-melanom-breslow-tiefe.md) (SNOMED CT 106243009)
* **Ulzeration**: [MII PR Onkologie Melanom Ulzeration](StructureDefinition-mii-pr-onko-melanom-ulzeration.md) (oBDS MM4)
* **Sicherheitsabstand**: [MII PR Onkologie Melanom Sicherheitsabstand](StructureDefinition-mii-pr-onko-melanom-sicherheitsabstand.md) (oBDS MM1)
* **LDH**: [MII PR Onkologie Melanom LDH](StructureDefinition-mii-pr-onko-melanom-ldh.md) Laktatdehydrogenase als prognostischer Marker
* **Melanom-Exzision**: **Melanom Exzision**  mit SNOMED CT Codes für Hautexzisionen
* **Bundle-Beispiel**: [Melanom Bundle](example-melanom-bundle.md) demonstriert vollständigen Melanom-Workflow
 
* **Bundle-Beispiele**: Für alle organspezifischen Module ([Mamma Bundle](example-mamma-bundle.md), [Prostata Bundle](Bundle-mii-exa-onko-prostata-example-bundle-1.md), [KRKBundle](example-krk-bundle.md), [Melanom Bundle](example-melanom-bundle.md)) stehen vollständige Transaktions-Bundles zur Verfügung, die alle zugehörigen Profile in einem server-konsumierbaren Format demonstrieren
