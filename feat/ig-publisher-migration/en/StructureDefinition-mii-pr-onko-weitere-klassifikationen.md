...
1. Der Suchparameter "method" SOLLTE unterstützt werden:Beispiele:`GET [base]/Observation?method=http://snomed.info/sct|254373007`Anwendungshinweise: Ermöglicht die Suche nach spezifischen Klassifikationsmethoden (z.B. FIGO, Ann Arbor Hodgkin vs. Non-Hodgkin). Weitere Informationen zur Suche nach "method" finden sich in der FHIR-Basisspezifikation - Abschnitt "token".

**Beispiele**

[Beispiel: mii-exa-onko-weitere-klassifikationen-1](Observation-mii-exa-onko-weitere-klassifikationen-1.md)

[Beispiel: mii-exa-onko-weitere-klassifikationen-2](Observation-mii-exa-onko-weitere-klassifikationen-2.md)

[Beispiel: mii-exa-onko-weitere-klassifikationen-3](Observation-mii-exa-onko-weitere-klassifikationen-3.md)

[Beispiel: mii-exa-onko-weitere-klassifikationen-4](Observation-mii-exa-onko-weitere-klassifikationen-4.md)
