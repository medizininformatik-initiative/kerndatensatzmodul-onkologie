...
[Beispiel: mii-exa-onko-residualstatus-1](Observation-mii-exa-onko-residualstatus-1.md)

**Usages:**

* Examples for this Profile: [Observation/mii-exa-onko-residualstatus-1](Observation-mii-exa-onko-residualstatus-1.md)
* CapabilityStatements using this Profile: [MII CPS Onkology CapabilityStatement](CapabilityStatement-mii-cps-onko-capabilitystatement.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-pr-onko-residualstatus.json)
