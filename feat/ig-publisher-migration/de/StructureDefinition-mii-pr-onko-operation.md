...
Weitere Informationen: [MII EX Onko Operation Intention](StructureDefinition-mii-ex-onko-operation-intention.md)
...
Weitere Informationen: [MII EX Onko Operation Urgency](StructureDefinition-mii-ex-onko-operation-urgency.md)
...
[Beispiel: mii-exa-onko-operation-1](Procedure-mii-exa-onko-operation-1.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-pr-onko-operation.json)
