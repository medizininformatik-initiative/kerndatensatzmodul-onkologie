...
1. Der Suchparameter "code" MUSS unterstützt werden:Beispiele:`GET [base]/Observation?code=http://loinc.org|21889-1`Anwendungshinweise: Weitere Informationen zur Suche nach "code" finden sich in der FHIR-Basisspezifikation - Abschnitt "token".
...
1. Der Suchparameter "effective" MUSS unterstützt werden:Beispiele:`GET [base]/Observation?effective=2024-01-15`Anwendungshinweise: Weitere Informationen zur Suche nach "effective" finden sich in der FHIR-Basisspezifikation - Abschnitt "date".

**Beispiele**

[Beispiel: mii-exa-onko-mamma-tumorgroesse-1](Observation-mii-exa-onko-mamma-tumorgroesse-1.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-pr-onko-tumorgroesse.json)
