...
1. Der Suchparameter "body-site" MUSS unterstützt werden:Beispiele:`GET [base]/Observation?bodysite=http://fhir.de/CodeSystem/icd-o-3|C00.4`Anwendungshinweise: Weitere Informationen zur Suche nach "derived-from" finden sich in der FHIR-Basisspezifikation - Abschnitt "reference".

**Beispiele**

[Beispiel: mii-exa-onko-histologie-icdo3](Observation-mii-exa-onko-histologie-icdo3.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-ig-onko-de-v2026|current/StructureDefinition/StructureDefinition-mii-pr-onko-histologie-icdo3.json)
