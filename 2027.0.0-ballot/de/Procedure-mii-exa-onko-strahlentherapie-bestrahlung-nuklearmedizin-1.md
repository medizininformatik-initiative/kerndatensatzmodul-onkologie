# Strahlentherapie: Beispiel einer Nuklearmedizinischen Bestrahlungstherapie - MII IG Kerndatensatz-Modul Onkologie v2027.0.0-ballot
...
Profile: [MII PR Onkologie Strahlentherapie Nuklearmedizin](StructureDefinition-mii-pr-onko-strahlentherapie-bestrahlung-nuklearmedizin.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-strahlentherapie-bestrahlung-nuklearmedizin|2027.0.0-ballot"]
  },
  "extension" : [{
